...
<body>
	...
	<div class="mb-3 d-flex justify-content-between">
		...
		<c:if test="${post.po_me_id eq user.me_id}">
			<div>
				<a href="<c:url value="/post/update/${post.po_bo_num}"/>" class="btn btn-outline-warning">수정</a>
				<a href="<c:url value="/post/delete/${post.po_bo_num}"/>" class="btn btn-outline-danger">삭제</a>
			</div>
		</c:if>
